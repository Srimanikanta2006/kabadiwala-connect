...
## 5. Upcoming Implementation Chunks
...
| **Chunk 2** | Supabase database connection & seed data migration | `backend/app/models/`, Supabase client | **NEXT UP** |
| **Chunk 3** | Offline storage (Dexie.js IndexedDB), Service Worker & i18next | `frontend/src/db/`, `frontend/src/i18n/` | Queued |
